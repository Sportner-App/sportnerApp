      ...
      >
        <View className="flex-row items-center gap-3 border-b border-white/10 p-4">
          <View className="relative h-11 w-11 items-center justify-center rounded-full bg-brand-primary/15">
            <Text className="font-display text-sm text-brand-primary">AY</Text>
          ...
          <View className="flex-1">
            ...
            <Text className="mt-0.5 font-body text-xs text-brand-primary">
        ...
        <View className="gap-2.5 p-4">
          ...
          >
            <Text className="font-body text-xs leading-5 text-white">
          ...
          >
            <Text className="font-body-bold text-xs leading-5 text-brand-secondary">
